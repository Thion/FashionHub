...
class TrousersUploadActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_trousers_upload)


        imageUris = mutableListOf()
        recyclerView = findViewById(R.id.trousersrecyclerView)
        recyclerView.layoutManager = GridLayoutManager(this, 2)
        adapter = ImageAdapter(imageUris)
        recyclerView.adapter = adapter

        itemTitleEditText = findViewById(R.id.mEdtTrousersName)
        itemDescriptionEditText = findViewById(R.id.mEdtDescriptionTrousers)
        itemPriceEditText = findViewById(R.id.mEdtPriceTrousers)
        itemImageView = findViewById(R.id.TrousersimageView)
        saveItemButton = findViewById(R.id.TrousersBtnSave)
        updateItem = findViewById(R.id.TrousersBtnUpdate)
    ...
    private fun saveProduct() {
        ...
        val databaseRef = FirebaseDatabase.getInstance().getReference("trousers").push()
