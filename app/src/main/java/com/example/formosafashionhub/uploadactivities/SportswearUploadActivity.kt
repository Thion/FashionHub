...
class SportswearUploadActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sportswear_upload)


        imageUris = mutableListOf()
        recyclerView = findViewById(R.id.sportswearrecyclerView)
        recyclerView.layoutManager = GridLayoutManager(this, 2)
        adapter = ImageAdapter(imageUris)
        recyclerView.adapter = adapter

        itemTitleEditText = findViewById(R.id.mEdtSportswearName)
        itemDescriptionEditText = findViewById(R.id.mEdtDescriptionSportswear)
        itemPriceEditText = findViewById(R.id.mEdtPriceSportswear)
        itemImageView = findViewById(R.id.SportswearimageView)
        saveItemButton = findViewById(R.id.SportswearBtnSave)
        updateItem = findViewById(R.id.SportswearBtnUpdate)
    ...
    private fun saveProduct() {
        ...
        val databaseRef = FirebaseDatabase.getInstance().getReference("sportswear").push()
