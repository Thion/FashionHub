...
class OthersUploadActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_others_upload)
        ...
        itemTitleEditText = findViewById(R.id.mEdtOthersName)
        itemDescriptionEditText = findViewById(R.id.mEdtDescriptionOthers)
        itemPriceEditText = findViewById(R.id.mEdtPriceOthers)
        itemImageView = findViewById(R.id.OthersimageView)
        saveItemButton = findViewById(R.id.OthersBtnSave)
        updateItem = findViewById(R.id.OthersBtnUpdate)
    ...
    private fun saveProduct() {
        ...
        val databaseRef = FirebaseDatabase.getInstance().getReference("others").push()
