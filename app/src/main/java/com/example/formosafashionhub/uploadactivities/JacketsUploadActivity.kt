...
class JacketsUploadActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_jackets_upload)


        imageUris = mutableListOf()
        recyclerView = findViewById(R.id.jacketsrecyclerView)
        recyclerView.layoutManager = GridLayoutManager(this, 2)
        adapter = ImageAdapter(imageUris)
        recyclerView.adapter = adapter

        itemTitleEditText = findViewById(R.id.mEdtJacketsName)
        itemDescriptionEditText = findViewById(R.id.mEdtDescriptionJackets)
        itemPriceEditText = findViewById(R.id.mEdtPriceJackets)
        itemImageView = findViewById(R.id.JacketsimageView)
        saveItemButton = findViewById(R.id.JacketsBtnSave)
        updateItem = findViewById(R.id.JacketsBtnUpdate)
    ...
    private fun saveProduct() {
        ...
        val databaseRef = FirebaseDatabase.getInstance().getReference("jackets").push()
