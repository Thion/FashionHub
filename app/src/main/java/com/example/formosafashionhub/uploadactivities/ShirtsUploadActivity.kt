...
class ShirtsUploadActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_shirts_upload)


        imageUris = mutableListOf()
        recyclerView = findViewById(R.id.shirtsrecyclerView)
        recyclerView.layoutManager = GridLayoutManager(this, 2)
        adapter = ImageAdapter(imageUris)
        recyclerView.adapter = adapter

        itemTitleEditText = findViewById(R.id.mEdtShirtsName)
        itemDescriptionEditText = findViewById(R.id.mEdtDescriptionShirts)
        itemPriceEditText = findViewById(R.id.mEdtPriceShirts)
        itemImageView = findViewById(R.id.ShirtsimageView)
        saveItemButton = findViewById(R.id.ShirtsBtnSave)
        updateItem = findViewById(R.id.ShirtsBtnUpdate)
    ...
    private fun saveProduct() {
        ...
        val databaseRef = FirebaseDatabase.getInstance().getReference("shirts").push()
